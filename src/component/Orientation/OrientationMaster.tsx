...
const OrientationMaster: React.FC<Props> = () => {
                ...
                <Row>
                    <Col xs={12} sm={6} md={6} lg={6}>
                        <div className='title d-block text-start '>
                            <p>Orientation vers <span>Master</span></p>
                            <img src="/images/black-lines.png" alt="" />
                        </div>
                        <div>
                            <p className="text-start"> Veuillez choisir votre spécialité de Master <a href="/">( voir la liste des modules )</a> </p>
...
export default OrientationMaster;